...
class DirectionViolationDetection:
    def __init__(self, vid_file):  # vid_file = 'videos/traffic.avi'
        ...
        # Removed cv2.VideoCapture completely to prevent FFMPEG native segfaults 
        # inside headless PySpark executor daemon threads. We will hardcode fallback 
        # sizes, and later dynamically update them in feedCap from the array shape.
        self.w = 640
        self.h = 480
                ...
                for i in self.vehicles:
                    if abs(x - i.getX()) <= w and abs(y - i.getY()) <= h:
                        ...
                        if i.going_UP(self.line_down, self.line_up):
                            ...
                            retDict['list_of_cars'].append(roi.copy())
