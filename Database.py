...
class Database:
    ...
    def __init__(self):
        if Database.__instance is not None:
            ...
            import os
            db_path = os.path.join(r"c:\Users\HP\OneDrive\Desktop\Big Data Project\Traffic-Rules-Violation-Detection", "database", "traffic.db")
    ...
    def search(self, cam=None, color=None, license=None, time=None):
        ...
        for row in rows:
            ret.append({
                ...
                KEYS.CARIMAGE: ("car_images/" + row[6]) if row[6] else None,
                KEYS.LICENSENUMBER: row[5],
                KEYS.LICENSEIMAGE: ("license_images/" + row[4]) if row[4] else None,
